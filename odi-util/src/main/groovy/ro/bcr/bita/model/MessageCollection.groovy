...
class MessageCollection implements IMessageCollection{
	...
	public String toString() {
		String rsp="${this.getClass()}@${Integer.toHexString(this.hashCode())}->Keys:${this.getNoOfKeys()}->${this.getKeys()}";
		return rsp;
	}
	/********************************************************************************************
	 *
	 ...
	 *
	 ********************************************************************************************/
	public IMessageCollection plus(List<String> messages) {
		this.add(messages);
		return this;
	}
	public IMessageCollection leftShift(List<String> messages) {
		this.add(messages);
		return this;
	}
	...
	public IMessageCollection each(Closure actionOnList) throws IllegalArgumentException{
